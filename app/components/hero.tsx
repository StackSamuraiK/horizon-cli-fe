...
export const Hero = () => {
    return (
        <div id="home" className="grid grid-cols-2">
            <div className="flex flex-col gap-4 justify-start items-start p-10 pt-56 relative">
                ...
                <h1 className="text-6xl font-extrabold relative z-10 bg-clip-text text-transparent bg-gradient-to-br from-white via-neutral-200 to-neutral-500 leading-tight">Horizon CLI</h1>
                <p className="text-neutral-400 relative z-10 text-lg font-medium tracking-wide leading-relaxed max-w-md mt-2">
                    An intelligent AI agent that lives directly in your terminal, ready to scaffold, automate, and deploy your next big idea.
                </p>

                {/* Feature Tags */}
                <div className="flex flex-wrap gap-3 mt-6 relative z-10 w-full">
